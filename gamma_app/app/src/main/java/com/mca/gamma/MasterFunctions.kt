...
class Https() {
    ...
    // register request
    fun signUp(text1: String, text2: String, text3: String): String {

        val client = OkHttpClient()
        val url = "$serverAddress/signup"
    ...
    //login https request
    fun login(text1: String, text2: String ) {
    ...
    fun codeVerify(text1: String): String {

        val client = OkHttpClient()
        val url = "$serverAddress/codeVerify"
    ...
    fun changePassword2(code: String, email: String, password: String): Boolean {

        val client = OkHttpClient()
        val url = "$serverAddress/changePassword2"
    ...
    fun changePassword1(email: String): Boolean {

        val client = OkHttpClient()
        val url = "$serverAddress/changePassword"
    ...
    fun changeUsername(newUsername: String): Boolean {

        val client = OkHttpClient()
        val url = "$serverAddress/changeUsername"
...
class CardViews(): AppCompatActivity() {
    ...
    //IN THE FUTURE , AN ICON WILL BE SENT ALONGSIDE THE FRIEND REQUEST
    @SuppressLint("InflateParams")
    fun mainUiCard() {
    ...
    private fun connAcceptRefuseCard() {
    ...
    private fun removeFromFriendsCard() {
